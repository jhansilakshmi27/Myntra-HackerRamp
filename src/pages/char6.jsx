  ...
  return (
    <div className="w-full relative [background:linear-gradient(180deg,_rgba(255,_52,_222,_0.9)_8.35%,_rgba(254,_86,_15,_0.9)_92.17%)] h-[64rem] overflow-hidden text-left text-[2rem] text-black font-ibm-plex-sans">
      ...
      <div className="absolute top-[11.063rem] left-[12.688rem] w-[60rem] h-[37.875rem] text-[1.875rem] font-inter">
        <div className="absolute top-[0rem] left-[0rem] text-[2rem] font-extrabold text-gray-100 whitespace-pre-wrap inline-block w-[46.438rem] h-[3.563rem]">{`Prabhas  Costumes & Accesories:`}</div>
        
        <div className="absolute top-[4.063rem] left-[4.188rem] w-[27.188rem] h-[33.813rem]">
          ...
          <div className="absolute top-[1.813rem] left-[2.875rem] w-[21.688rem] h-[23.375rem]">
            <img
              ...
              alt=""
              src={imageStates.image1 ? "/bahubali_dress.png" : "/rectangle-594@2x.png"}
              onClick={() => handleImageClick("image1")}
            />
            <img
              className="absolute h-[12.03%] w-[12.97%] top-[5.88%] right-[7.78%] bottom-[82.09%] left-[79.25%] max-w-full overflow-hidden max-h-full object-cover"
              alt=""
        ...
        <div className="absolute top-[4.063rem] left-[32.813rem] w-[27.188rem] h-[33.813rem]">
          ...
          <div className="absolute top-[1.813rem] left-[2.625rem] w-[21.688rem] h-[23.375rem]">
            <img
              className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] rounded-21xl max-w-full overflow-hidden max-h-full object-cover"
              alt=""
              
               src={imageStates.image2 ? "/bahubali_chain.png" : "/rectangle-616@2x.png"}
              onClick={() => handleImageClick("image2")}
            />
            <img
              className="absolute h-[12.03%] w-[12.97%] top-[5.88%] right-[6.34%] bottom-[82.09%] left-[80.69%] max-w-full overflow-hidden max-h-full object-cover"
              alt=""
              src="/synchronize@2x.png"
            />
          </div>
