const Char = () => {
  return (
    <div className="w-full relative [background:linear-gradient(180deg,_rgba(255,_52,_222,_0.9)_8.35%,_rgba(254,_86,_15,_0.9)_92.17%)] h-[64rem] overflow-hidden text-left text-[2rem] text-black font-ibm-plex-sans">
      ...
      <div className="absolute top-[11.063rem] left-[12.688rem] w-[60.438rem] h-[38.563rem] text-[1.875rem] font-inter">
        <div className="absolute top-[0rem] left-[0rem] text-[2rem] font-extrabold text-gray-100 inline-block w-[46.438rem] h-[3.563rem]">{`Margot Robbie Costumes & Accesories:`}</div>
        <div className="absolute top-[4.75rem] left-[4.875rem] w-[27.188rem] h-[33.813rem]">
          ...
          <div className="absolute top-[1.75rem] left-[2.813rem] w-[21.688rem] h-[23.375rem]">
            <img
          ...
          <div className="absolute top-[27.188rem] left-[2.813rem] w-[21.688rem] h-[3.875rem]">
            <img
              className="absolute top-[0.063rem] left-[16.875rem] w-[4.813rem] h-[3.813rem] object-cover"
              alt=""
              src="/bookmark@2x.png"
            />
            <img
        ...
        <div className="absolute top-[4.75rem] left-[33.25rem] w-[27.188rem] h-[33.813rem]">
          <div className="absolute top-[0rem] left-[0rem] rounded-6xl bg-gray-400 box-border w-[27.188rem] h-[33.813rem] border-[2px] border-solid border-black" />
          <div className="absolute top-[27.188rem] left-[3rem] w-[21.438rem] h-[3.875rem]">
            <img
          ...
          <div className="absolute top-[1.75rem] left-[2.688rem] w-[21.688rem] h-[23.375rem]">
            <img
              className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] rounded-21xl max-w-full overflow-hidden max-h-full object-cover"
              alt=""
